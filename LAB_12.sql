--------LAB 12--------
DELETE FROM STUDENT_10 WHERE RNO=101
DELETE FROM STUDENT_10 WHERE RNO=102
...
AS
UPDATE STUDENT_10 SET BRANCH='EC' WHERE BRANCH='EE' AND RNO=105
